<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<head>
		...
		<link rel="stylesheet" href="/src/main/resources/static/signUpLogin/fonts/icomoon/style.css">

		<link rel="stylesheet" href="/src/main/resources/static/signUpLogin/css/owl.carousel.min.css">

		<!-- Bootstrap CSS -->
		<link rel="stylesheet" href="/src/main/resources/static/signUpLogin/css/bootstrap.min.css">

		<!-- Style -->
		<link rel="stylesheet" href="/src/main/resources/static/signUpLogin/css/style.css">

		<link rel="stylesheet" href="/src/main/resources/static/signUpLogin/css/userStyle.css">
	...
	<%@include file="./Header.jsp" %>
									...
									<form id="member_frm" action="memberInsert.do" method="post" name="member_frm">
										...
										<div class="form-group first field--not-empty">
											...
											<div class='email_check col-md-3'>
												<!-- emailCheck.do로 넘어간다. -->
												<button type="button" id="btn_emailCheak"
													class="btn_check btn-pill btn-orange"><span
														class="text-white btn_text">중복확인</span></button>
											</div>
										</div>
										...
										<div class="AddrAdd">
											<div class="form-group">                   
												<input class="form-control" style="width: 40%; display: inline;" placeholder="우편번호" name="addr1" id="addr1" type="text" readonly="readonly" >
													<button type="button" class="btn btn-orange" onclick="execPostCode();"><i class="fa fa-search"></i> 우편번호 찾기</button>                               
												</div>
												<div class="form-group">
										...
										<input type="button" value="가입하기" id="btn_signUp"
											class="btn btn-pill btn-block text-white btn-orange">
										<div class="d-flex mb-5 align-items-center" id="homeGO">
											<label class="control control--checkbox mb-0"><span class="caption"></span>
											</label>
											<span class=""><a href="#" class="forgot-pass">홈 화면으로 가기</a></span>
											<span class="ml-auto"><a href="#" class="forgot-pass">로그인하기</a></span>
										</div>
									</form>
								</div>
							</div>
		...
		<script src="/src/main/resources/static/signUpLogin/js/jquery-3.3.1.min.js"></script>
		<script src="/src/main/resources/static/signUpLogin/js/popper.min.js"></script>
		<script src="/src/main/resources/static/signUpLogin/js/bootstrap.min.js"></script>
		<script src="/src/main/resources/static/signUpLogin/js/main.js"></script>
		<script src="/src/main/resources/static/signUpLogin/js/member.js"></script>
